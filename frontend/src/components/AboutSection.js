...
const AboutPage = () => {
  return (
    <section className="bg-gradient-to-b from-[#0a0f1a] via-[#0f1626] to-black text-gray-300 min-h-screen py-24 px-6 sm:px-10">
      {/* ===== PAGE HEADER ===== */}
      <motion.div
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        >
          <img
            ...
            alt="About CCTV"
            className="rounded-2xl shadow-lg border border-blue-600/20 hover:shadow-blue-500/20 transition-all"
          />
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          {[
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-6 bg-gradient-to-br from-blue-900/20 to-black/40 border border-blue-500/20 rounded-2xl shadow-md hover:shadow-blue-500/20 transition"
            >
